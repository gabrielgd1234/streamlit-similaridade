...
def carregar_base_atg():
    return pd.read_excel(r"R:\Estatistica\Estudos\2025\dash teste\baseatg.xlsx")
...
with tab2:
    ...
    with st.expander("Instruções - Rotina 2", expanded=True):
        ...
        **2.** O modelo irá comparar com a base fixa localizada em:  
        `R:/Estatistica/Estudos/2025/dash teste/baseatg.xlsx`
